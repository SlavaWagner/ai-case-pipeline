...
function showAgyPrerequisiteWarning(attemptedCmd) {
  ...
  console.log(yellowBox('================================================================================'));
  console.log();
  console.log(whiteBold('  Die AI Case Pipeline funktioniert ausschließlich'));
  ...
  console.log(chalk.yellow('  kannst du mit den Befehlen der ai-case-pipeline chatten und die'));
  console.log(chalk.yellow('  Case-Forge- und Analyse-Workflows bedienen.'));
  console.log();
  ...
  console.log(whiteBold('     In Antigravity kannst du interaktiv mit den Case Pipeline Agenten'));
  console.log(whiteBold('     chatten und sämtliche Auswertungs- und Case-Study-Workflows steuern.'));
  console.log();
  console.log(yellowBox('================================================================================'));
...
program
  ...
  .description('Autonomous AI Case Forge for Google Ads Performance Analysis & Content Creation (requires Antigravity CLI)')
  .version('1.0.0');
